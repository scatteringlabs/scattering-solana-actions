        ...
        content: {
            'application/json': {
                schema: zod_openapi_1.z.object({
                    icon: zod_openapi_1.z.string(), // image
                    label: zod_openapi_1.z.string(), // button text
                    title: zod_openapi_1.z.string(),
                    description: zod_openapi_1.z.string(),
                    disabled: zod_openapi_1.z.boolean().optional(), // allows to model invalid state of the action e.g. nft sold out
                    links: zod_openapi_1.z.object({
                        ...
                        actions: zod_openapi_1.z
                            ...
                            href: zod_openapi_1.z.string(), // solana pay/actions get/post url
                            label: zod_openapi_1.z.string(), // button text
                            ...
                            parameters: zod_openapi_1.z.array(zod_openapi_1.z.object({
                                name: zod_openapi_1.z.string(), // parameter name in url
...
exports.actionsSpecOpenApiPostResponse = {
    '200': {
        ...
        content: {
            'application/json': {
                schema: zod_openapi_1.z.object({
                    transaction: zod_openapi_1.z.string(), // base64-encoded serialized transaction
                    message: zod_openapi_1.z.string().optional(), // the nature of the transaction response e.g. the name of an item being purchased
