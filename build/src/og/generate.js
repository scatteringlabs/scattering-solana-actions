...
var og = new hono_1.Hono();
og.post('/', /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(c) {
    var _yield$c$req$json, htmlContent, browser, page, screenshot;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 2:
          ...
          htmlContent = _yield$c$req$json.htmlContent;
          if (htmlContent) {
            _context.next = 6;
            break;
          }
        ...
        case 19:
          return _context.abrupt("return", c.body(screenshot, 200, {
